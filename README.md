...
```
.
├── spot-frontend-web/       # Next.js (own git)
├── spot-frontend-mobile/    # Expo (own git)
├── spot-admin-console/      # Vite admin (own git)
├── spot-backend/            # Express API (tracked here)
├── spot-ai-services/        # planned FastAPI (empty)
├── docker-compose.yml
├── docker-compose.production.yml
├── DOCKER.md / CLAUDE.md / CURSOR.md / PROJECT_RULES.md
├── Docs/ , PA/              # course materials only
```
