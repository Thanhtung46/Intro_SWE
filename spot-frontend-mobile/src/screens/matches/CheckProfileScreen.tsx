...
import { getErrorMessage, getHostProfile, listMatches, setFavorite } from '@/services/matchService';
import type { HostProfile, Match, Sport } from '@/types/match';
 ...
 * "Hide Groups / verified / reviews"): no Verified badge, no star rating,
 * no Reviews section, no Groups section — `HostProfile.rating`/
 * `reviewCount` are always null/0 until the Review domain ships, and
 * Groups is locked per note #1. This isn't a TODO, it's the shipped state.
 */
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 20, fontWeight: '700', color: colors.headingText },
