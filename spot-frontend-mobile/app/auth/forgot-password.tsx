...
import { ForgotPasswordFieldErrors, forgotPasswordSchema } from '../../src/schemas/forgotPasswordSchema';
...
export default function ForgotPasswordScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (response.success) {
      router.push({ pathname: '/auth/reset-password', params: { email: result.data.email } });
      return;
    }
